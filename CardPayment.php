  ...
  <div class="block text-left">
    ...
    <form action="Include/CardPayment.inc.php" method="post">
      ...
      <div class="form-group col-lg-8">
        ...
        <input type="text" id="card_name" name="card_name" class="form-control" placeholder="Card Holder Name" required>
      </div>
      ...
      <div class="form-group mt-3">
        <button type="submit" name="confirm_payment" class="btn btn-main btn-round-full">Confirm Payment</button>
        <button type="submit" name="cancel_payment" class="btn btn-secondary btn-round-full">Cancel Payment</button>
      </div>
