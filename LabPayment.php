            ...
            <div class="row">
              <div class="col-lg-9">
                <div class="form-group">
                  <input name="LPname" id="LPname" type="text" class="form-control" placeholder="Your Name" required>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">
                  <input name="LPage" id="LPage" type="number" min="0" class="form-control" placeholder="Your Age" required>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <input name="LPphone" id="LPphone" type="tel" class="form-control" placeholder="Phone Number" required>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <input name="LPemail" id="LPemail" type="email" class="form-control" placeholder="Email" required>
                </div>
              </div>
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  <input name="LPdate" id="LPdate" type="date" class="form-control" placeholder="Date (dd/mm/yyyy)" required>
                </div>
              </div>
